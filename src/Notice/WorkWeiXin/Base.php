...
namespace DtApp\Notice\WorkWeiXin;

use DtApp\Notice\WorkWeiXinClient;
use DtApp\Tool\DtAppException;
use DtApp\Tool\Tool;

class Base extends WorkWeiXinClient
{
    /**
     * 消息类型
     * @var string
     ...
     * @throws DtAppException
     */
    protected static function markdown(string $webhook, string $content = '')
    {
